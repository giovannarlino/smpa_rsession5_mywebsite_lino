...
# **Possible questions to be asked based on the data:**

1.  Create a map of the republican vote in all of the counties for both president and governor.

2.  Analyze the counties with the biggest democratic victory.

3.  Analyze the counties with the biggest republican victory.

4.  Was there a county in which Biden won for which the democratic governor didn't?
